...
<hr /></td>
        ...
        <td width="80%" align="left" valign="top"><table width="485" height="272" border="0" align="center" cellpadding="3" cellspacing="0">
          <tr>
            <td height="272"><p>
  <?php
			session_start();
			...
			if($submit)
			{
				...
				{	
					$pass = md5($pass);
				$query = mysql_query("SELECT * FROM stafflogin WHERE staffuser='$user'");
				$numrows = mysql_num_rows($query);
					if($numrows !=0)
					{
						while($row=mysql_fetch_assoc($query))
					{
						$dbusername = $row['staffuser'];
						...
						$_SESSION['staffuser']=$dbusername;	
						}
						else
							echo "<font size='+1' color='red'>Incorrect Password</font>";		
					}
					else
						echo "<font size='+1' color='red'>Sorry that username doesnt exist</font>";
			}
			else
...
<legend align="center">Login Form</legend>	
 ...
 if($_SESSION['staffuser'])
 {
  ...
  <table width='96%' border='0' cellspacing='0' cellpadding='3' class='altrowstable' id='alternatecolor'>
  <tr><td>
    ...
    <tr><td></td><td>
	<input type='submit' name='login' value='  log in  ' align='middle' /></td></tr></table>
	</form>";
	}
	?>
	</fieldset></div>
