...
<table width="1000" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="5">
    <tr>
        <td width="42"><b>ID</b></td>
        <td width="196"><b>Title</b></td>
        <td width="285"><b>Message</b></td>
        <td width="137"><b>Author</b></td>
        <td width="93"><b>Replies</b></td>
        <td width="79"><b>Posted</b></td>
        <td width="58"><b>State</b></td>
        <td width="30"><b></b></td>
    </tr>
</table>
   <?php
// Retrieve data from database
 include 'includes/connect.php';
$sql="SELECT * FROM threads where state=0";
...
<table width='1000' border=1 cellpadding='5' class="altrowstable" id="alternatecolor">
    <tr>
        ...
        <td width="204"><?php echo  $rows[title]; ?></td>
        <td width="281"><?php echo  $rows[message]; ?></td>
        <td width="146"><?php echo $rows[author]; ?></td>
        <td width="62"><?php echo $rows[replies]; ?></td>
        <td width="100"><?php echo $rows[posted]; ?></td>
        <td width="41"><?php echo $rows[state]; ?></td>
        <td width="27"><?php echo "<a href='dthreads.php?id=$rows[id]'><img src='pics/b_drop.png' width='16' height='16'/></a>";?></td>
    </tr>
</table>
</div>
<?php
