...
<table width="1000" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td width="260">Research</td>
  </tr>
  <tr>
    <td align="left" valign="top"><a href="staffaddresearch.php">Add Research</a></td>
  </tr>
   <tr>
  <td height="102">
     <div id="row">
 <table width="1000" border="0" cellspacing="0" cellpadding="5">
    <tr>
        ...
        <td width="203" align="left"><b>Title</b></td>
        <td width="159" align="left"><b>Description</b></td>
      <td width="159" align="center"><b>Researchers Name</b></td>
        <td width="109" align="center"><b>Start date</b></td>
        <td width="99" align="center"><b>End date</b></td>
        <td width="104" align="center"><b>Value(ksh)</b></td>
        <td width="52" align="center"><b>File</b></td>
    </tr>
</table>
   <?php
...
<table width='1000' border=1 cellpadding='5' class="altrowstable" id="alternatecolor" >
    <tr>
        ...
        <td width="23"><?php print $rows[ID]; ?></td>
        <td width="204"><?php print $rows[ResTitle]; ?></td>
        <td width="165"><?php print  $rows[Description]; ?></td>
        <td width="153" align="center"><?php print $rows[Name]; ?></td>
        <td width="102" align="center"><?php print $rows[Start_date]; ?></td>
        <td width="100" align="center"><?php print $rows[End_date]; ?></td>
        <td width="100" align="center"><?php print $rows[ValueKSH]; ?></td>  
        <td width="37" align="center"><?php echo "<a href='resdownload.php?id=$rows[ID]'><font size='+1' color='black'>view</font> </a>";?></td>  
  </tr> 
</table>
</div>
<?php
