  ...
  <tr>
    <td height="0"><table width="1000" border="0" align="center" cellpadding="3" cellspacing="0">
      <tr>
        ...
        <div class="myform">
    <table width="194" border="0" cellspacing="2" cellpadding="2">
      <tr>
        <td width="186" height="54"><a href="studentpage1.php">Student Project</a>
          <hr /></td>
      </tr>
      <tr>
        <td height="55"><a href="studentresearch.php">Research Project</a>
          <hr /></td>
      </tr>
    </table></div>
        </td>
