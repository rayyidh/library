...
<br></td></tr>
<tr><td>
Thread Title:</td><td><input name="title" type="text" value="<?php echo $_POST['title']; ?>" size="54" />  <br></td></tr>
<tr><td>
Thread:<br></td><td><textarea cols="60" rows="5" name="message"><?php echo $_POST['message']; ?></textarea><br></td></tr>
...
echo "<p><font color='#0000FF'><a href='staffshow.php?id=$r[id]'><font color='#0000FF'>$r[title]</font></a> ($r[replies] Replies)</font></p><b>$r[author]</b> : $r[message]<h5>Posted on $posted</h5>";
echo"<hr>";}
