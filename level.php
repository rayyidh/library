...
<table width="1000" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    <td align="left" valign="top"><a href="addlevel.php">Add Level</a></td>
  </tr>
 <tr>
  ...
  <table width="390" border="0" cellspacing="0" cellpadding="5">
    <tr>
        <td width="101"><b>ID</b></td>
        <td width="210"><b>Level</b></td>
        <td width="49"></td>
...
// Retrieve data from database
 include 'includes/connect.php';
$sql="SELECT * FROM level where state=0";
...
<table width='390' border=1 cellpadding='5'class="altrowstable" id="alternatecolor">
    <tr>
        ...
        <td width="167"><?php echo  $rows[level]; ?></td>
        <td width="33"><?php echo "<a href='dlevel.php?id=$rows[id]'><img src='pics/b_drop.png' width='16' height='16'/></a>";?></td>
    </tr>
</table>
</div>
<?php
