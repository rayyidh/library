...
<table width="1000" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td width="231">Welcome to Student Page</td>
  </tr>
  <tr>
    <td align="left" valign="top"><a href="addstudent.php">Add Student</a></td>
   </tr>
 <tr>
 ...
 <table width="1000" border="0" cellspacing="0" cellpadding="5">
    <tr>
        <td width="186"><b>Registration number</b></td>
        <td width="315" align="left"><b>Student Name</b></td>
        <td width="218" align="left"><b>Year</b></td>
      <td width="241"><b>ID/Passport no.</b></td>
    </tr>
</table>
   <?php
// Retrieve data from database
 include 'includes/connect.php';
  error_reporting (E_ALL ^ E_NOTICE);
	$term = $_POST['term'];
	$submit=$_POST['submit'];
	$sql = mysql_query("select * from students where state=0");
...
<table width='1000' border=1 cellpadding='5' class="altrowstable" id="alternatecolor">
    <tr>
        ...
        <td width="180"><?php print $rows[regno]; ?></td>
        <td width="311"><?php print $rows[studentname]; ?></td>
        <td width="227"><?php print  $rows[year]; ?></td>
        <td width="179"><?php print $rows[ID_passportno]; ?></td> 
        <td width="29"><?php echo "<a href='dstudent.php?id=$rows[regno]'><img src='pics/b_drop.png' width='16' height='16'/></a>";?></td>    
  </tr> 
</table>
</div>
<?php
